Projeto de automação, na qual foi utilizado script em Python para envio no Discord de informações de containers que vieram a parar, informações estas sendo Nome, ID e data de quando parou.
